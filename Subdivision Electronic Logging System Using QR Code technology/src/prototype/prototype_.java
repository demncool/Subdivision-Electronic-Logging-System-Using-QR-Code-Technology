...
public class prototype_ extends JFrame {
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					prototype_ frame = new prototype_();
	...
	public prototype_() {
		...
		JButton newVisitor = new JButton("New Visitor");
		...
		JButton going_in = new JButton("Coming In");
		going_in.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
		...
		going_in.setBounds(103, 233, 186, 35);
		contentPane.add(going_in);
		
		JButton going_out = new JButton("Going Out");
		going_out.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				Camera_out camOut = new Camera_out();
				camOut.setVisible(true);
			}
		});
		going_out.setBounds(103, 319, 186, 35);
		contentPane.add(going_out);
		...
		copy.setBounds(0, 478, 94, 14);
		contentPane.add(copy);
		
		JButton visitorsList = new JButton("View List");
		visitorsList.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				VisitorList allList = new VisitorList();
